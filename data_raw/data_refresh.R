...
start_time <- base::min(base::max(US_elec$date_time),
                      base::max(US_source$date_time),
                      base::max(Cal_elec$date_time)) +
  lubridate::hours(1)


end_time <- as.POSIXct("2019-11-25 00:00:00", tz = "UTC") - lubridate::hours(1)
